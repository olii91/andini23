    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">Pengaduan Bontang</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Pelayanan</a>
            </div>
        </header>
        <!-- Services-->
